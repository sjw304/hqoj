...
public class ValidAspect {
    ...
    @Pointcut("execution(public * top.quezr.hqoj.controller.*.*(..))")
    public void valid() {
    }
    ...
    public Object arround(ProceedingJoinPoint pjp) {
        try {
            ...
            log.error("excuting error : {}",e.getMessage());
            e.printStackTrace();
            return new Response<>().failure("服务器错误： "+e.getMessage());
        }
    }
